...
\usepackage{placeins} %dovrebbe risolvere lo spostarsi delle immagini
\begin{document}
...
\begin{figure}[h]
	...
	\begin{subfigure}{0.3\textwidth}
		\centering
		\includegraphics[ height=4cm]{Pictures/fingerOnToroidal/MoldFirstStep.jpg} 
		\caption{First step mold}
		\label{fig:moldFirstStep}
	\end{subfigure}
	\hfill
	\begin{subfigure}{0.3\textwidth}
		\centering
		\includegraphics[height=4cm]{Pictures/fingerOnToroidal/MoldSecondStep.JPG}
		\caption{Second step mold}
		\label{fig:moldSecondStep}
	\end{subfigure}
	\hfill
	\begin{subfigure}{0.3\textwidth}
	\centering
		\includegraphics[height=4cm]{Pictures/fingerOnToroidal/MoldThirdStep.jpg}
		\caption{Third step mold}
		\label{fig:moldThirdStep}
	\end{subfigure}
 
	\caption{Molds utilized}
	\label{fig:allMold}
\end{figure}
...
\begin{wrapfigure}[10]{!ht}{0.5\textwidth}
\centering
